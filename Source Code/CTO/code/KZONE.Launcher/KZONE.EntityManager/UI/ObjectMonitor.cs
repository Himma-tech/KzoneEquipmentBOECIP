...
namespace KZONE.EntityManager.UI
{
    public partial class ObjectMonitor : Form
    {
        ...
        private static void CheckTuple(Dictionary<string, object> container, TreeNode root, object cls, string preName) {
            if (cls == null) {
                root.Text = preName + " = NULL";
                return;
            } else { ; }
            foreach (Type iType in cls.GetType().GetGenericArguments()) {
