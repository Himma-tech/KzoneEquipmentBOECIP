...
namespace KZONE.Entity
{
	...
	/// </summary>
	public class SecsVariableDataEntityData:EntityData
	{
		...
		public SecsVariableDataEntityData() { }

        public SecsVariableDataEntityData(string lINETYPE, string lINEID, string sERVERNAME, string nODENO, string dATATYPE, string tRID, string iTEMNAME, string iTEMTYPE, string iTEMID, string dESCRIPTION, string iTEMSET, string sP1, string sP2, string sP3)
		{
