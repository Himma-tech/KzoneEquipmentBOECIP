...
{
	#region SBRMRECIPEPARAMETER

	/// <summary>
	/// SBRMRECIPEPARAMETER object for NHibernate mapped table 'SBRM_RECIPEPARAMETER'.
	/// </summary>
	public class RecipeParameterEntityData:EntityData
	{
