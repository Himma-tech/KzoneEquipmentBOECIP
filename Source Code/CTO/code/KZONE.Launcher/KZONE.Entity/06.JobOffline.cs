...
namespace KZONE.Entity
{
    ...
    public class OFFLINEPRODUCTDATAc : ICloneable
    {
        ...
        public string SOURCE_FACTORY { get; set; }
        //add by zouyang.TotalReworkCount.CF Repair Line.
        public string TOTALREWORKCOUNT { get; set; }
        ...
        public OFFLINEPRODUCTDATAc()
        {
            ...
            SOURCE_FACTORY = string.Empty;
            TOTALREWORKCOUNT = string.Empty;
        }
