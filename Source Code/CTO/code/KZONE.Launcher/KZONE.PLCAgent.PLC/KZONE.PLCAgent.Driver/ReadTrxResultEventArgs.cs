...
{
	/// <summary>
	/// ReadTrx Result event argurments
	/// </summary>
	public class ReadTrxResultEventArgs : EventArgs
	{
		/// <summary>
		/// source trx
		/// </summary>
		...
		/// <param name="hasErr">read operation has error occure</param>
		/// <param name="msg">return message</param>
		/// <param name="station">source station,0=station not specific</param>
		public ReadTrxResultEventArgs(Trx trx, int station, bool hasErr, int code, string msg)
		{
			this.SourceTrx = trx;
