...
namespace KZONE.EntityManager
{
	public abstract class EntityManager
	{
        ...
        public virtual void InsertHistory(EntityData data) {
            try {
                NLogManager.Logger.LogDebugWrite(LoggerName, GetType().Name, MethodInfo.GetCurrentMethod().Name + "()", data.GetType().Name);
                HistoryHibernateAdapter.SaveObject(data);
            } catch (Exception ex) {
                Debug.Print(ex.Message);
            }
        }
        ...
        public virtual void InsertHistory(EntityData[] data) {
            try {
                if (data != null && data.Length > 0) {
                    ...
                    HistoryHibernateAdapter.SaveObjectAll(data);
                }
            } catch {
            }
        }
        ...
        /// <summary>
        /// Delete Entity Data from DB by Array
        /// </summary>
        /// <param name="data"></param>
        ...
        /// <summary>
        /// sub class override this method entity Serialize File Type
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Convert xmlNode to Object
        /// </summary>
        /// <param name="obj"></param>
        /// <param name="node"></param>
        public static void ConvertXMLToObject(object obj, XmlNode node) {
            try {
                ...
                foreach (PropertyInfo info in properties) {
                    try {
                        ...
                        NLogManager.Logger.LogErrorWrite("", "", MethodBase.GetCurrentMethod().Name + "()", string.Format("Property Name=[{0}], getValue error.\r", info.Name) + ex.ToString());
                    }
                }
            } catch (Exception ex) {
