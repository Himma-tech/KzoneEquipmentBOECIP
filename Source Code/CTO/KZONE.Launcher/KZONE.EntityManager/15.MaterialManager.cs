    ...
    public class MaterialManager : EntityManager, IDataSource
    {
        ...
        protected override void AfterInit(List<EntityData> entityDatas, List<EntityFile> entityFiles)
        {
            foreach (EntityFile entity_file in entityFiles)
            {
                ...
                {
                    string material_key = string.Format("{0}_{1}_{2}", material_entity.NodeNo, material_entity.UnitNo, material_entity.MaterialId);
        ...
        public void SaveMaterialHistory(string equipmentID, string unitNo, MaterialEntity currentMaterial, string oldMaterialId,string permitCode="",string count="0")
        {
            try
            {
                MaterialHistory materialHistory = new MaterialHistory()
                {
                    ...
                    SLOTNO = currentMaterial.SlotNo.ToString(),
