...
namespace KZONE.UI
{
    public class Dense
    {
        ...
        //    this.PortEnable =DenseData.PORTENABLEMODE==string.Empty ? ePortEnable.Unused:(ePortEnable)int.Parse(DenseData.PORTENABLEMODE);            
        ...
        //    this.PortEnable = DenseData.BODY.PORTENABLEMODE == string.Empty ? ePortEnable.Unused : (ePortEnable)int.Parse(DenseData.BODY.PORTENABLEMODE);
