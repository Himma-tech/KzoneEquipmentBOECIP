    ...
    public partial class FormBase : Form
    {
        ...
        public void ShowMessage(Form parent, string msgCaption, string messageCode, string message, MessageBoxIcon showIcon, string stackTrace = "")
        {
            try
            {
                ...
                //    default:
                //        _opiType = eOPIMessageType.Information;
                //        break;
                //}

                OPIInfo.Q_OPIMessage.Enqueue(new OPIMessage(msgCaption, messageCode, message));
            }
            catch (Exception ex)
            {
                NLogManager.Logger.LogErrorWrite("",this.GetType().Name, MethodBase.GetCurrentMethod().Name, ex);
        ...
        //public void ShowMessage(Form parent, string msgCaption, UniAuto.UniBCS.HKC.OpiSpec.Return OpiSpecReturn, MessageBoxIcon showIcon)
        //{
        ...
        //        else
        //        {
        //            UniAuto.UniBCS.HKC.OpiSpec.Message bcs_message = Spec.CheckXMLFormat(_rsp.Xml);
        ...
        //    try
        //    {
        //        string uiREX = string.Format("KZONE.UI.Properties.{0}", FormMainMDI.Language.ToString());
