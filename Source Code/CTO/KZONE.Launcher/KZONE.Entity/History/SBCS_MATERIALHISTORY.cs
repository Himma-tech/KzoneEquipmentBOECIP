...
namespace KZONE.Entity
{
	...
	public class MaterialHistory
	{
        ...
        public MaterialHistory(string nODEID, string uNITNO, DateTime uPDATETIME, string mATERIALID, string mATERIALCOUNT, string mATERIALSTATUS, string mATERIALTYPE, string oPERATORID, string sLOTNO, string oLDMATERIALID, string pERMITCODE)
		{
			this._nODEID = nODEID;
			this._uNITNO = uNITNO;
