...
namespace KZONE.Entity
{
    ...
    public class eJOBDATA
    {
        ...
        #region  HKC  PLC DATA                    
        public const string CassetteSequenceNumber = "CassetteSequenceNumber";
        public const string SlotSequenceNumber = "CassetteSlotNumber";
        public const string JobID = "GlassID";
        ...
        public const string ProcessSkipFlag = "ProcessSkipFlag";
        public const string LastGlassFlag = "LastGlassFlag";
        public const string CIMModeCreate = "CIMModeCreate";
        public const string SamplingFlag = "SamplingFlag";
        public const string Reserved = "Reserved";
        public const string InspectionJudgeResult = "InspectionJudgeResult";
        public const string InspectionReservationSignal = "InspectionReservationSignal";
        public const string ProcessReservationSignal = "ProcessReservationSignal";
        public const string TrackingDataHistory = "TrackingDataHistory";
        public const string EquipmentSpecialFlag = "EquipmentSpecialFlag";
        public const string GlassID = "GlassID";
        public const string SorterGrade = "SorterGrade";
        public const string GlassGrade = "GlassGrade";
        public const string FromPortNo = "FromPortNo";
        public const string TargetPortNo = "TargetPortNo";
        public const string TargetSlotNo = "TargetSlotNo";
        public const string TargetCassetteID = "TargetCassetteID";
        public const string Reserve = "Reserve";
        public const string PPID = "PPID";

        //22003L 22004L Add
        public const string NGMark = "NGMark";
        //public const string ChangerFlag = "ChangerFlag";
       ...
       // public const string LotID = "LotID";
        ...
        //CF Photo Line
        public const string LineSpecialflag = "LineSpecialflag";
        public const string EngraveFlag = "EngraveFlag";
        //CF FMA Line
        public const string TurnFlag = "TurnFlag";
        //CF MSC Line
        public const string MaskInspecationResult = "MaskInspecationResult";
        public const string TurnOverCount = "TurnOverCount";

        //20170204 SAP_1~4 Line
        public const string ToUnloaderPort = "ToUnloaderPort";
        public const string ToOriginalPort = "ToOriginalPort";

        //20170221 F1SOR,F1SAP,F1ACM,F1FAH,F1FRE,F1IRP
        public const string ChangerFlag = "Changerflag";
        ...
        public const string ReworkCount = "PIReworkCount";
        //C1ODF
        public const string ArrayTTPEQVersion = "ArrayTTPEQVersion";
        public const string CFCasetteSeqNo = "CFCasetteSeqNo";
        public const string CFJobSeqNo = "CFJobSeqNo";
        public const string ODFBoxChamberOpenTime_01 = "ODFBoxChamberOpenTime_01";
        public const string ODFBoxChamberOpenTime_02 = "ODFBoxChamberOpenTime_02";
        public const string ODFBoxChamberOpenTime_03 = "ODFBoxChamberOpenTime_03";
        public const string RepairCount = "RepairCount";
        public const string UVMaskAlreadyUseCount = "UVMaskAlreadyUseCount";
        public const string CriterialNumber = "CriterialNumber";
        //C1LOI
       ...
       // public const string DefectCode="DefectCode";
        public const string CellRepairProcessCount = "CellRepairProcessCount";
        public const string POLReworkCount = "POLReworkCount";
        //C1CUT
        public const string PanelOXInfo = "PanelOXInfo";
      //  public const string ChipCount = "ChipCount";
        ...
        public const string CrossLineGroupNumber = "CrossLineGroupNumber";

        public const string OXRInformation = "OXRInformation";

        //C1LSC
        public const string ToBufferFlag = "ToBufferFlag";

        //M1OLB LSCProcessCount
        public const string LSCProcessCount = "LSCProcessCount";
        public const string FinalJudgeFlag = "Final_Judge_Flag";
