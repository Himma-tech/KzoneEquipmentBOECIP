...
namespace KZONE.Entity
{
	...
	/// <summary>
	/// SBRMFDCDATA object for NHibernate mapped table 'SBRM_FDCDATA'.
	/// </summary>
	public class FDCDataEntityData:EntityData
	{
