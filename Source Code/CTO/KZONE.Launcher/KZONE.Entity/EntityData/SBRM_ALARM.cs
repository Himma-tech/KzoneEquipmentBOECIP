...
namespace KZONE.Entity
{
	...
	public class AlarmEntityData:EntityData
	{
        ...
        public AlarmEntityData(string lINEID, string nODENO, string uNITNO, string aLARMLEVEL, string aLARMID,int bCALARMID, string aLARMCODE, string aLARMTEXT, string sERVERNAME)
		{
			this._lINEID = lINEID;
			this._nODENO = nODENO;
			this._uNITNO = uNITNO;
