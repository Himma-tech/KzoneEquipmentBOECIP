...
{
	#region SBRMPROCESSDATA

	/// <summary>
	/// SBRMPROCESSDATA object for NHibernate mapped table 'SBRM_PROCESSDATA'.
	/// </summary>
	public class ProcessDataEntityData:EntityData
	{
