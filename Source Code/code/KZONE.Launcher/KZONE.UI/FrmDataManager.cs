            ...
            try
            {
                ...
                if (_dgvDataGird.SelectedRows.Count > 0)
                {
                    ...
                    else if (_treTreeView.SelectedNode.Text == "LineManager")
                    {
                      ...
                      KZONE.Entity.Line  line = ObjectManager.LineManager.GetLine(lineName);
                        if (line != null)
                        {
                            obj = line;
                            objectName = lineName;
                    ...
                    else if (_treTreeView.SelectedNode.Text == "PortManager")
                    {
                     ...
                     KZONE.Entity.Port port = ObjectManager.PortManager.GetPort(portId);
                        if (port != null)
                        {
                            obj = port;
                            objectName = portId;
                    ...
                    else if (_treTreeView.SelectedNode.Text == "UnitManager")
                    {
                     ...
                     KZONE.Entity.Unit unit = ObjectManager.UnitManager.GetUnit(unitId);
                        if (unit != null)
                        {
                            obj = unit;
                            objectName = unitId;
